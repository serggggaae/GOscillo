...
void disp_dds_freq(void) {
  if (dac_cw_mode) {
    ...
    if (frequency < 10.0)
      ...
      display.print(frequency / 1000, 5);
      display.print('k');
    } else if (frequency < 100000.0) {
      display.print(frequency / 1000, 4);
      display.print('k');
    } else if (frequency < 1000000.0) {
      display.print(frequency / 1000, 3);
      display.print('k');
    } else if (frequency < 10000000.0) {
      display.print(frequency / 1000000, 5);
      display.print('m');
    } else {
      display.print(frequency / 1000000, 4);
      display.print('m');
    }
  } else {
